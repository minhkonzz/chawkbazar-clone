...
export const requestPasswordReset = async (email: string, baseUrl: string) => {
  ...
  await transporter.sendMail({
    ...
    text: `Your password reset link: ${baseUrl}/reset-password?token=${resetPasswordToken}`,
    html: ""
  });
...
export const resetPassword = async (token: string, plainPassword: string) => {
