...
const CartItem = ({ data }) => {
  ...
  return (
    ...
    <div className="cart-item d-flex jc-sb at-center w-100pc">
      <div className="cart-item-img posrel thin-bd-r o-h"> 
        <img className="posab w-100pc" />
        <div className="del-icon posab w-100pc h-100pc ex-blur">
          <span className="posab pos-center">
            <ion-icon name="close-circle"/>
          </span>
        </div>
      ...
      <div className="cart-item-info">
        <p className="item-name">Lorem Isum</p>
        <p className="item-unit-price">{`Unit price: $200`}</p>
        <div className="d-flex w-100pc jc-sb at-center">
          <div className="qty-ctl d-flex dark-v thin-bd-r">
            <button className="qty-ctl-btn h-100pc bg-transparent"><ion-icon name="remove"/></button>
            <span className="qty d-flex jc-center at-center h-100pc">20</span>
            <button className="qty-ctl-btn h-100pc bg-transparent"><ion-icon name="add"/></button>
          </div>
          <span><b>{`$200`}</b></span>
        </div>
      </div>
