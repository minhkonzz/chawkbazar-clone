   ...
   function ProductDetail({ 
      ...
      const variation = useMemo(() => 
         product?.variations.reduce(
            (acc: { sizes: ProductVariation[], colors: ProductVariation[] }, cur: ProductVariation) => {
         ...
         <div {...{ref}} className={`${styles.container} d-flex posab pos-center`}>
            <div className={`${styles.about} w-100pc`}>
               ...
               <div className={`${styles.addedCartMessage} d-flex at-center`}>
                  <span className={`${styles.addedCartIc} d-flex at-center jc-center`}>
                     <svg 
                        stroke="currentColor" 
                        fill="currentColor" 
                        strokeWidth="0" 
               ...
               <div className={`${styles.addons} d-flex`}> {
                  variation.sizes
                  .map((addon: ProductVariation, i: number) => (
                     <span 
                        key={i} 
                        className={`
                           ${styles.addon} 
