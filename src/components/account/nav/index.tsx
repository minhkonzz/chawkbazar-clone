   ...
   return (
      <svg 
         ...
         <path 
            ...
            strokeLinecap="round" 
            strokeLinejoin="round" 
            strokeWidth="32" d="M160 288h249.44a8 8 0 007.85-6.43l28.8-144a8 8 0 00-7.85-9.57H128">
         </path>
      </svg>
   );
};
...
const links = [
   ...
   { id: "nl3", path: "/change-password", title: "Change password", ic: PasswordIcon }
];

export default function AccountNav({ styles }: {
