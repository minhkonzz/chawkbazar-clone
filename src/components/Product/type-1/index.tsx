...
const Product = ({ data }: any) => {
  ...
  return (
    ...
    <div className="product__list-item">
      ...
      <div className="product__list-item__about">
        <p className="product__list-item__name">data_name</p>
        <p className="product__list-item__description">Self-striped knitted midi A-line dress...</p>
        <div className="product__list-item__prices">
          <span className="product__list-item__sale-price">{`$200`}</span>
          <span className="product__list-item__price">{`$200`}</span>
        </div>
      </div>
    </div>
  )
