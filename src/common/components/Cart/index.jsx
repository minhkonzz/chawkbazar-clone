   ...
   return (
      <div className="cart" ref={cartRef}>
            ...
            <div className="d-flex fd-col w-100pc h-100pc jc-sa at-center">
               <svg width="180" height="309.722" viewBox="0 0 180 309.722">
                  ...
                  <g id="Group_5968" data-name="Group 5968" transform="translate(0 0)">
                     ...
                     <path id="Union_11" data-name="Union 11" d="M2.059,6.97l.989-3.048L0,2.933.283,2.06l3.049.989L4.321,0,5.2.284l-.99,3.048,3.047.989L6.97,5.2l-3.048-.99-.99,3.049Z" transform="translate(6.528 48.598)" fill="#212121" stroke="rgba(0,0,0,0)" strokeMiterlimit="10" strokeWidth="1" opacity="0.3"></path>
                     <path id="Union_13" data-name="Union 13" d="M2.059,6.97l.989-3.048L0,2.933.283,2.06l3.049.989L4.321,0,5.2.284l-.99,3.048,3.047.989L6.97,5.2l-3.048-.99-.99,3.049Z" transform="translate(94.294 121.132)" fill="#212121" stroke="rgba(0,0,0,0)" strokeMiterlimit="10" strokeWidth="1" opacity="0.3"></path>
                     <path id="Union_12" data-name="Union 12" d="M1.235,4.182l.593-1.829L0,1.759l.17-.524L2,1.829,2.592,0l.525.17L2.523,2l1.828.594-.17.523L2.353,2.523,1.759,4.352Z" transform="translate(107.351 6.528)" fill="#212121" stroke="rgba(0,0,0,0)" strokeMiterlimit="10" strokeWidth="1" opacity="0.3"></path>
                  </g></g></g></g>
               </svg>
         ...
         <div className="cart-bottom posrel">
            <button className="posab pos-center dark-v thin-bd-r fw-600">{`Proceed to checkout | $${cartItems.length === 0 ? 0 : Number(cartTotalPrice).toFixed(2)}`}</button>
         </div>
      </div>
   )
}
