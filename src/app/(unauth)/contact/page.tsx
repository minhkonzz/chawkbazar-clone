...
import ContactPart from "@/components/organisms/contact-part";
    ...
    <Banner title="Contact us">
      <div className={`${styles.wrapper} d-flex mx-auto`}>
        <div className={styles.contacts}>
          ...
          {contacts.map((e, i: number) => (
            <ContactPart key={i} icon={e.ic} title={e.title} desc={e.desc} />
          ))}
          <NextImage src="/map-image.jpg" alt="map" width={359} height={185} />
        </div>
