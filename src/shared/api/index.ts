import { RequestOptions } from "@/shared/interfaces/configs";
...
export default class BaseAPI {
   ...
   static post<T>(path: string, body: any, options: RequestOptions = {}): Promise<T> {
   ...
   static put<T>(path: string, body: any, options: RequestOptions = {}): Promise<T> {
